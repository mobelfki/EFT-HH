#ifndef TRUTHRIVETTOOLS_HIGGSTEMPLATECROSSSECTIONSSTAGE12_H
#define TRUTHRIVETTOOLS_HIGGSTEMPLATECROSSSECTIONSSTAGE12_H
...
namespace STXS {
  ...
  namespace Stage1_2_Fine {
    ...
    struct HiggsClassification {
      ...
      STXS::Stage1_2::Category stage1_2_cat_pTjet25GeV;
      STXS::Stage1_2::Category stage1_2_cat_pTjet30GeV;
      STXS::Stage1_2_Fine::Category stage1_2_fine_cat_pTjet25GeV;
      STXS::Stage1_2_Fine::Category stage1_2_fine_cat_pTjet30GeV;
    ...
    template <class category>
      ...
      cat.stage1_2_cat_pTjet25GeV = stxs_cat_rivet.stage1_2_cat_pTjet25GeV;
      cat.stage1_2_cat_pTjet30GeV = stxs_cat_rivet.stage1_2_cat_pTjet30GeV;
      cat.stage1_2_fine_cat_pTjet25GeV = stxs_cat_rivet.stage1_2_fine_cat_pTjet25GeV;
      cat.stage1_2_fine_cat_pTjet30GeV = stxs_cat_rivet.stage1_2_fine_cat_pTjet30GeV;
      cat.isZ2vvDecay = stxs_cat_rivet.isZ2vvDecay;
      return cat;    
    }
    

    
    inline int STXSstage1_2_to_STXSstage1_2_FineIndex(STXS::Stage1_2::Category stage1_2,
						 HiggsProdMode prodMode, tH_type tH) {

      if(stage1_2==STXS::Stage1_2::Category::UNKNOWN) return 0;
    ...
    inline int STXSstage1_2_to_STXSstage1_2_FineIndex(const HiggsClassification &stxs,
						 tH_type tH=noTH, bool jets_pT25 = false) {
      STXS::Stage1_2::Category stage1_2 =
    jets_pT25==false?stxs.stage1_2_cat_pTjet30GeV:
    stxs.stage1_2_cat_pTjet25GeV;
      return STXSstage1_2_to_STXSstage1_2_FineIndex(stage1_2,stxs.prodMode,tH);
    }
    
    inline int STXSstage1_2_to_index(STXS::Stage1_2::Category stage1_2) {
    ...
    inline int STXSstage1_2_Fine_to_STXSstage1_2_Fine_FineIndex(STXS::Stage1_2_Fine::Category Stage1_2_Fine,
                         HiggsProdMode prodMode, tH_type tH) {

      if(Stage1_2_Fine==STXS::Stage1_2_Fine::Category::UNKNOWN) return 0;
    ...
    inline int STXSstage1_2_Fine_to_STXSstage1_2_Fine_FineIndex(const HiggsClassification &stxs,
                         tH_type tH=noTH, bool jets_pT25 = false) {
      STXS::Stage1_2_Fine::Category Stage1_2_Fine =
    jets_pT25==false?stxs.stage1_2_fine_cat_pTjet30GeV:
    stxs.stage1_2_fine_cat_pTjet25GeV;
      return STXSstage1_2_Fine_to_STXSstage1_2_Fine_FineIndex(Stage1_2_Fine,stxs.prodMode,tH);
    }

    inline int STXSstage1_2_Fine_to_index(STXS::Stage1_2_Fine::Category Stage1_2_Fine) {
